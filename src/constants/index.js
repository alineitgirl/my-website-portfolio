export const navLinks = [
  { id: 1, name: "Contact", type: "contact" },
  { id: 2, name: "Projects", type: "photos" },
...
const WORK_LOCATION = {
  ...
  children: [
    // ▶ Project 1
    {
      ...
      windowPosition: "top-[5vh] left-55", // optional: Finder window position
      children: [
        {
          id: 1,
    ...
    // ▶ Project 2
    {
      ...
      kind: "folder",
      position: "top-52 right-80",
      windowPosition: "top-[20vh] left-250",
      children: [
        {
          id: 1,
